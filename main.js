...
// Chair
itemLoader.load(
  "Assets/dublin_chair/scene.gltf",
  function (gltf) {
...
// Pipe Lamp
itemLoader.load(
  "Assets/industrial_pipe_lamp/scene.gltf",
  function (gltf) {
    const model = gltf.scene;
...
// Desk Fan
itemLoader.load(
  "Assets/retro-style_desk_fan/scene.gltf",
  function (gltf) {
    const model = gltf.scene;
...
// Table
itemLoader.load(
  "Assets/victorian_console_table/scene.gltf",
  function (gltf) {
    const model = gltf.scene;
